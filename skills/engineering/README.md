...
- **[implement](./implement/SKILL.md)** — Build the work described by a spec or set of tickets, drive `/tdd` at pre-agreed seams, review it with `/code-review`, then require `/verifying-work` proof before committing.
